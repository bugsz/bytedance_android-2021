...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notesAdapter = new NoteListAdapter(new NoteOperator() {
            ...
            public void deleteNote(Note note) {
                // TODO: 2021/7/19 7. 此处删除数据库数据（完成）
                MainActivity.this.deleteNote(note);
            }

            @Override
            public void updateNote(Note note) {
                // TODO: 2021/7/19 7. 此处更新数据库数据（完成）
    ...
    private void updateNote(Note note) {
        ...
        int updatedRows = database.update(TodoContract.TodoNote.TABLE_NAME, values, selection, selectionArgs);
    ...
    private List<Note> loadNotesFromDatabase() {
        ...
        // TODO: 2021/7/19 7. 此处query数据库数据 （完成）
        String []projection = null;
        String selection = null;
        String []selectionArgs = null;
        String sortOrder = TodoContract.TodoNote.COLUMN_NAME_PRIORITY + " DESC";
